...
from logic_utils import check_guess, get_range_for_difficulty, initial_game_state, parse_guess, update_score
...
if st.session_state.get("last_hint") and show_hint:
